...
describe("Capitalize", () => {
  ...
  test("should return uppercased Universe", () => {
...
describe("FilterOddNumber", () => {
  ...
  it("should return [2, 4, 6]", () => {
    expect(filterOddNumber([2, 3, 4, 5, 6, 7])).toEqual([2, 4, 6]);
  });
...
describe("EpochDateToUTC", () => {
  ...
  it("should return Sun, 12 Mar 2021 12:34:56 GMT", () => {
    expect(epochDateToUTC(1615637696)).toMatch("Sat, 13 Mar 2021");
  });

  it("should return Sat, 28 Nov 2018 18:45:30 GMT", () => {
